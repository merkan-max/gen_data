...
```{r}
fam = fread("C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.A2.fam")
...
```{r}
bim = fread("C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.A2.bim")
...
ggplot(fam, aes(x = V6)) +
  ...
  #The plot look roughly Gasussian/normally distributed, given that it is an almost-perfect bell-curve! Though, there is a slight skew towards the right. 
```
...
```{bash}
plink2 --bfile C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.A2 --maf 0.05 --geno 0.01 --mind 0.10 --hwe 0.00005 --make-bed --out C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.qc.A2
```
...
```{bash}
plink2 --bfile C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.qc.A2 --indep-pairwise 500 50 0.05 --out C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.qc_pruned.A2
```
```{bash}
plink2 --bfile C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.qc.A2 --extract C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.qc_pruned.A2.prune.in --make-bed --out C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.qc_pruned.A2
```
...
```{bash}
plink2 --bfile C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.qc_pruned.A2 --king-cutoff 0.0884 --out C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa_king.A2
```
...
```{bash}
plink2 --bfile C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.qc.A2 --keep C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa_king.A2.king.cutoff.in.id --make-bed --out C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.qc_unrelated.A2
```
...
```{bash}
plink2 --bfile C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.qc_unrelated.A2 --extract C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.qc_pruned.A2.prune.in --make-bed --out C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.qc_unrelated_pruned.A2
```
```{bash}
plink2 --bfile C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.qc_unrelated_pruned.A2 --pca 20 --out C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.unrelated_PCA.A2
```
...
```{bash}
plink2 --bfile C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.qc_unrelated.A2 --ci 0.95 --glm --covar C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.unrelated_PCA.A2.eigenvec --covar-name PC1,PC2,PC3 --adjust --out C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.qc_association.A2
```

(ii) Create a Manhattan plot of the GWAS results.

```{r}
association = data.table::fread("C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.qc_association.A2.PHENO1.glm.linear")

head(association)

association_additive = association[TEST == "ADD"]
association_additive = association_additive[association_additive$P > 0 & !is.na(association_additive$P), ] #Had to remove 0 or NA values, as the plot could not render due to "needing fintie ylim", source is https://stackoverflow.com/questions/73683696/error-in-making-a-manhattan-plot-need-finite-ylim-values

setnames(association_additive, c("#CHROM", "POS", "ID"), c("CHR", "BP", "SNP"))

manhattan(association_additive,
            chr = "CHR",
            bp = "BP",
            snp = "SNP",
            p = "P",
...
```{r}
qq(association_additive$P, main = "Q-Q Plot of GWAS p-values")
```
