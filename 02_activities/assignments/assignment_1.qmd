...
```{bash}   
plink2 --bfile C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.qc --export A --out C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa_qc_additive_A1
```
```{r}
...
plink2 --bfile C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.qc \
       --freq \
...
```{bash}         
plink2 --bfile C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa.qc --hardy --out C:/Users/Melis/OneDrive/Desktop/DSI/gen_data/02_activities/data/gwa_qc_hwe_A1
```
```{r}
...
```{r}        
#With each allele containing the SNP, the occurrence of the phenotype is increased by 0.05483 (B1) units, as it is additive
...
AIC = AIC(lm1, lm2)
print(AIC)
#AIC values of both models are very close to each other. While the recessive model would fit better, due to having a lower AIC, the difference is not significant.
```
